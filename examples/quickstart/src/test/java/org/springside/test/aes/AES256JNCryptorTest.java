...
public class AES256JNCryptorTest {
	...
	public static void main(String[] args) {
		AES256JNCryptorTest test = new AES256JNCryptorTest();
		try {
			test.testNullOrEmptyPassword();
		} catch (Exception e) {
...
//		assertEquals(AES256v3Ciphertext.EXPECTED_VERSION, ciphertext[0]);
	...
	/**
	 * Tests a {@link NullPointerException} is thrown when the ciphertext is null during decryption.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * Tests a {@link NullPointerException} is thrown when the plaintext is null during encryption.
	 * 
	 * @throws Exception
	 */
	@Test(expected = NullPointerException.class)
	...
	/**
	 * Performs an encryption followed by a decryption and confirms the data is the same. Uses the key-based methods.
	 * 
	 * @throws Exception
	 */
	@Test
	...
	public void testBadSaltLengthForKey() throws Exception {
		// new AES256JNCryptor().keyForPassword(null, new byte[AES256JNCryptor.SALT_LENGTH + 1]);
	}
	...
	/**
	 * Tests we get an exception if we try to decrypt a key-based ciphertext with a password.
	 * 
	 * @throws Exception
	 */
	@Test(expected = IllegalArgumentException.class)
